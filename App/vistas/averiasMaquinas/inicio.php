...
<div class="container">
    ...
    <?php endforeach ?>
        ...
        <table class="table table-hover">
            ...
            <tbody id="tablebody">
                <?php foreach($datos['averia'] as $averias): ?>

                    <tr>
                        <td><?php echo $averias->descripcion ?></td>
                        <td><?php echo $averias->num_horas_averia ?></td>
                        <td><?php echo $averias->lugar_reparacion ?></td>
                        <td><?php echo $averias->precio_reparacion ?></td>
                        <td><?php echo $averias->fecha ?></td>

                        <td class="text-center">
                            <a onclick="return confirm_delete()" href="<?php echo RUTA_URL ?>/AveriasMaquinas/borrar/<?php echo $averias->idaveria_maquina ?>"><button class="btn btn-danger"><i class="bi bi-trash"></i></button></a>
                                &nbsp;
                        </td>
                    </tr>
    ...
    <div id="modalAdd" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo RUTA_URL?>/AveriasMaquinas/anadirAveria/">
                    <div class="mt-3 mb-3">
                    ...
                    <div class="mt-3 mb-3">
                        <label for="num_horas">Nºhoras averia: <sup>*</sup></label>
