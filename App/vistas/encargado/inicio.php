        ...
        <div class="container">
                ...
                <div class="row mt-5 justify-content-around">
                    ...
                    <div class="borde border p-0 tarjeta shadow mb-5 bg-white col-md-1 col-sm-4 col-xl-6 col-12 rounded">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            <p class="card-text">
                                <a class="colorb" href="<?php echo RUTA_URL?>/maquinas"><h4>Máquinas</h4></a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="borde border p-0 tarjeta shadow mb-5 bg-white col-md-1 col-sm-4 col-xl-6 col-12 rounded">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            <p class="card-text">
                                <a class="colorb" href="<?php echo RUTA_URL?>/aperos"><h4>Aperos</h4></a>
                            </p>
                        </div>
                    ...
                    <div class="borde border p-0 tarjeta shadow mb-5 bg-white col-md-1 col-sm-4 col-xl-6 col-12 rounded">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            <p class="card-text">
                                <a class="colorb" href="<?php echo RUTA_URL?>/campos"><h4>Campos</h4></a>
                            </p>
                        </div>
                ...
                <div class="row mt-5 justify-content-around">
                    ...
                    <div class="borde border p-0 tarjeta shadow mb-5 bg-white col-md-1 col-sm-4 col-xl-6 col-12 rounded">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            <p class="card-text">
                                <a class="colorb" href="<?php echo RUTA_URL?>/cosechas"><h4>Cosechas</h4></a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="borde border p-0 tarjeta shadow mb-5 bg-white col-md-1 col-sm-4 col-xl-6 col-12 rounded">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            <p class="card-text">
                                <a class="colorb" href="<?php echo RUTA_URL?>/campanas"><h4>Campañas</h4></a>
                            </p>
                        </div>
                    ...
                    <div class="borde border p-0 tarjeta shadow mb-5 bg-white col-md-1 col-sm-4 col-xl-6 col-12 rounded">
                        ...
                        <div class="card-body d-flex justify-content-around">
                            <p class="card-text">
                                <a class="colorb" href="<?php echo RUTA_URL?>/colaboradores"><h4>Colaboradores</h4></a>
                            </p>
                        </div>
